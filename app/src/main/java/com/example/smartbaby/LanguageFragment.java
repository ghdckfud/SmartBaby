...
public class LanguageFragment extends Fragment {
    ...
    private ModeAdapter languageAdapter;
    private List<String> languageList;

    @Override
    public void onActivityCreated(Bundle b){
        super.onActivityCreated(b);
        TextView languageText = (TextView)getActivity().findViewById(R.id.languageText);
        TextView languageTitle = (TextView)getView().findViewById(R.id.languageTitle);
        LinearLayout linearLayout = (LinearLayout)getActivity().findViewById((R.id.notice));
        languageListView = (ListView)getView().findViewById(R.id.languageList);
        languageList = new ArrayList<String>();
        languageList.add("한국어");
        languageList.add("영어");
        languageAdapter = new ModeAdapter(getContext().getApplicationContext(), languageList , languageText ,languageTitle, linearLayout);
